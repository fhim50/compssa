...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('registration', (
            ...
            ('hall', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('room_number', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
            ('courses', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('remarks', self.gf('django.db.models.fields.TextField')(max_length=300, blank=True)),
        ))
    ...
    models = {
        u'register.registration': {
            ...
            'courses': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
